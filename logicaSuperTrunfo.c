...
int main() {
    ...
    // linha de ínicio do programa
    printf("Bem-vindo a Lógica do Super Trunfo!\n");

    // adicionando os valores de cada item
    char nome1[50] = "SP";
